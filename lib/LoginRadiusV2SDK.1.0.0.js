...
var LoginRadiusSDK = (function () {
    ...
    module.postMessageAPI = function (to, subject, message, handle) {
    ...
    module.statusPostingPOST = function (title, url, status, imageurl, caption, description, handle) {
    ...
    module.getLoginByEmail = function (email, password, verificationurl, loginurl, emailtemplate, grecaptcharesponse, handle) {
    ...
    module.getLoginByUserName = function (username, password, verificationurl, loginurl, emailtemplate, grecaptcharesponse, handle) {
    ...
    module.loginByEmail = function (jsObject, verificationurl, loginurl, emailtemplate, grecaptcharesponse, handle) {
    ...
    module.loginByUserName = function (jsObject, verificationurl, loginurl, emailtemplate, grecaptcharesponse, handle) {
        util.xhttpCall("POST", jsObject,"/identity/v2/auth/login?verificationurl=" + encodeURIComponent(verificationurl) + "&loginurl=" + loginurl + "&emailtemplate=" + emailtemplate + "&g-recaptcha-response=" + grecaptcharesponse, function (data) {
            handle(data);
        });
    };
