var LoginRadiusSDK = (function() {
  ...
  module.authenticationApi = { 
    ...
    */
    deleteAccountWithEmailConfirmation : function (accessToken, deleteUrl,
      ...
      return util.xhttpCall('DELETE', resourcePath, queryParameters, null, handle);
    },
    /**
    ...
    * 12.3
    */
    getSocialIdentity : function (accessToken, fields, handle) {
      if (util.isNull(accessToken)) {
        return handle(util.message('accessToken'));
      }
      var queryParameters = {};
  ...
  module.phoneAuthenticationApi = { 
    ...
    */
    phoneVerificationOTPByAccessToken : function (accessToken, otp,
      ...
      return util.xhttpCall('PUT', resourcePath, queryParameters, null, handle);
    },
    /**
  ...
  module.nativeSocialApi = { 
    ...
    * 20.3
    */
    getAccessTokenByFacebookAccessToken : function (fbAccessToken, handle) {
    ...
    * 20.4
    */
    getAccessTokenByTwitterAccessToken : function (twAccessToken, twTokenSecret, handle) {
    ...
    * 20.7
    */
    getAccessTokenByLinkedinAccessToken : function (lnAccessToken, handle) {
    ...
    * 20.16
    */
    getAccessTokenByGoogleAuthCode : function (googleAuthcode, handle) {
  ...
  module.socialApi = { 
    ...
    */
    postMessage : function (accessToken, message,
      ...
      return util.xhttpCall('POST', resourcePath, queryParameters, null, handle);
    },
    /**
