var LoginRadiusSDK = (function() {
    ...
    module.getPhotos = function(albumId, handle) {
        var access_token = module.getToken();
        if (access_token) {
            util.jsonpCall("/api/v2/photo?albumid=" + albumId + "&access_token=" + access_token, function(data) {
                handle(data);
            });
        } else {
            handle(errorMsgs[906]);
        }
    ...
    module.getCheckins = function(handle) {
        var access_token = module.getToken();
        if (access_token) {
            util.jsonpCall("/api/v2/checkin?access_token=" + access_token, function(data) {
                handle(data);
            });
        } else {
            handle(errorMsgs[906]);
    ...
    module.getAlbums = function(handle) {
        var access_token = module.getToken();
        if (access_token) {
            util.jsonpCall("/api/v2/album?access_token=" + access_token, function(data) {
                handle(data);
            });
        } else {
            handle(errorMsgs[906]);
    ...
    module.getAudios = function(handle) {
        var access_token = module.getToken();
        if (access_token) {
            util.jsonpCall("/api/v2/audio?access_token=" + access_token, function(data) {
                handle(data);
            });
        } else {
            handle(errorMsgs[906]);
    ...
    module.getMentions = function(handle) {
        var access_token = module.getToken();
        if (access_token) {
            util.jsonpCall("/api/v2/mention?access_token=" + access_token, function(data) {
                handle(data);
            });
        } else {
            handle(errorMsgs[906]);
    ...
    module.getFollowings = function(handle) {
        var access_token = module.getToken();
        if (access_token) {
            util.jsonpCall("/api/v2/following?access_token=" + access_token, function(data) {
                handle(data);
            });
        } else {
            handle(errorMsgs[906]);
    ...
    module.getEvents = function(handle) {
        var access_token = module.getToken();
        if (access_token) {
            util.jsonpCall("/api/v2/event?access_token=" + access_token, function(data) {
                handle(data);
            });
        } else {
            handle(errorMsgs[906]);
    ...
    module.getPosts = function(handle) {
        var access_token = module.getToken();
        if (access_token) {
            util.jsonpCall("/api/v2/post?access_token=" + access_token, function(data) {
                handle(data);
            });
        } else {
            handle(errorMsgs[906]);
    ...
    module.getCompanies = function(handle) {
        var access_token = module.getToken();
        if (access_token) {
            util.jsonpCall("/api/v2/company?access_token=" + access_token, function(data) {
                handle(data);
            });
        } else {
            handle(errorMsgs[906]);
    ...
    module.getGroups = function(handle) {
        var access_token = module.getToken();
        if (access_token) {
            util.jsonpCall("/api/v2/group?access_token=" + access_token, function(data) {
                handle(data);
            });
        } else {
            handle(errorMsgs[906]);
    ...
    module.getStatuses = function(handle) {
        var access_token = module.getToken();
        if (access_token) {
            util.jsonpCall("/api/v2/status?access_token=" + access_token, function(data) {
                handle(data);
            });
        } else {
            handle(errorMsgs[906]);
    ...
    module.getContacts = function(cursor, handle) {
        var access_token = module.getToken();
        if (access_token) {
            util.jsonpCall("/api/v2/contact?nextcursor=" + cursor + "&access_token=" + access_token, function(data) {
                handle(data);
            });
        } else {
            handle(errorMsgs[906]);
    ...
    module.getVideos = function(handle) {
        var access_token = module.getToken();
        if (access_token) {
            util.jsonpCall("/api/v2/video?access_token=" + access_token, function(data) {
                handle(data);
            });
        } else {
            handle(errorMsgs[906]);
    ...
    module.getLikes = function(handle) {
        var access_token = module.getToken();
        if (access_token) {
            util.jsonpCall("/api/v2/like?access_token=" + access_token, function(data) {
                handle(data);
            });
        } else {
            handle(errorMsgs[906]);
    ...
    module.postStatus = function(title, url, status, imageurl, caption, description, handle) {
        var access_token = module.getToken();
        if (access_token) {
            util.jsonpCall("/api/v2/status/js?title=" + title + "&url=" + url + "&imageurl=" + imageurl + "&status=" + status + "&caption=" + caption + "&description=" + description + "&access_token=" + access_token, function(data) {
                handle(data);
            });
        } else {
            handle(errorMsgs[906]);
    ...
    module.getUserProfile = function(handle) {
        var access_token = module.getToken();
        if (access_token) {
            util.jsonpCall("/api/v2/userprofile?access_token=" + access_token, function(data) {
                handle(data);
            });
        } else {
            handle(errorMsgs[906]);
    ...
    module.postMessagePOST = function(to, subject, message, handle) {
        var access_token = module.getToken();
        if (access_token) {
            util.xhttpCall("POST", {}, "/api/v2/message?to=" + to + "&subject=" + subject + "&message=" + message + "&access_token=" + access_token, function(data) {
                handle(data);
            });
        } else {
            handle(errorMsgs[906]);
    ...
    module.postStatusPOST = function(title, url, status, imageurl, caption, description, handle) {
        ...
        if (access_token) {
            ...
            util.xhttpCall("POST", {}, "/api/v2/status?title=" + title + "&url=" + url + "&imageurl=" + imageurl + "&status=" + status + "&caption=" + caption + "&description=" + description + "&access_token=" + access_token, function(data) {
                handle(data);
            });
        } else {
            handle(errorMsgs[906]);
    ...
    module.postMessage = function(to, subject, message, handle) {
        var access_token = module.getToken();
        if (access_token) {
            util.jsonpCall("/api/v2/message/js?to=" + to + "&subject=" + subject + "&message=" + message + "&access_token=" + access_token, function(data) {
                handle(data);
            });
        } else {
            handle(errorMsgs[906]);
    ...
    module.getPage = function(pagename, handle) {
        var access_token = module.getToken();
        if (access_token) {
            util.jsonpCall("/api/v2/page?pagename=" + pagename + "&access_token=" + access_token, function(data) {
                handle(data);
            });
        } else {
            handle(errorMsgs[906]);
    ...
    module.readAllProfilesByToken = function(handle) {
        var access_token = module.getToken();
        if (access_token) {
            util.jsonpCall("/identity/v2/auth/account?access_token=" + access_token + "&apikey=" + module.getApiKey(), function(data) {
                handle(data);
            });
        } else {
            handle(errorMsgs[906]);
    ...
    module.socialIdentity = function(handle) {
        var access_token = module.getToken();
        if (access_token) {
            util.jsonpCall("/identity/v2/auth/socialidentity?access_token=" + access_token + "&apikey=" + module.getApiKey(), function(data) {
                handle(data);
            });
        } else {
            handle(errorMsgs[906]);
    ...
    module.validateAccessToken = function(handle) {
        var access_token = module.getToken();
        if (access_token) {
            util.jsonpCall("/identity/v2/auth/access_token/validate?access_token=" + access_token + "&apikey=" + module.getApiKey(), function(data) {
                handle(data);
            });
        } else {
            handle(errorMsgs[906]);
    ...
    module.accessTokenInvalidate = function(handle) {
        var access_token = module.getToken();
        if (access_token) {
            util.jsonpCall("/identity/v2/auth/access_token/invalidate?access_token=" + access_token + "&apikey=" + module.getApiKey(), function(data) {
                handle(data);
            });
        } else {
            handle(errorMsgs[906]);
    ...
    module.getSecurityQuestionsByAccessToken = function(handle) {
        var access_token = module.getToken();
        if (access_token) {
            util.jsonpCall("/identity/v2/auth/securityquestion/accesstoken?access_token=" + access_token + "&apikey=" + module.getApiKey(), function(data) {
                handle(data);
            });
        } else {
            handle(errorMsgs[906]);
    ...
    module.getCustomObjectByToken = function(objectname, handle) {
        var access_token = module.getToken();
        if (access_token) {
            util.jsonpCall("/identity/v2/auth/customobject?access_token=" + access_token + "&objectname=" + objectname + "&apikey=" + module.getApiKey(), function(data) {
                handle(data);
            });
        } else {
            handle(errorMsgs[906]);
    ...
    module.getCustomObjectByRecordIdAndToken = function(objectname, objectrecordid, handle) {
        var access_token = module.getToken();
        if (access_token) {
            util.jsonpCall("/identity/v2/auth/customobject/" + objectrecordid + "?access_token=" + access_token + "&objectname=" + objectname + "&apikey=" + module.getApiKey(), function(data) {
                handle(data);
            });
        } else {
            handle(errorMsgs[906]);
    ...
    module.getApiKeyNoMessage = function() {
        if (getBrowserStorage("lrApiKey")) {
            apikey = getBrowserStorage("lrApiKey");
            return getBrowserStorage("lrApiKey");
    ...
    module.addEmail = function(jsObject, verificationurl, emailtemplate, handle) {
        var access_token = module.getToken();
        if (access_token) {
            util.xhttpCall("POST", jsObject, "/identity/v2/auth/email?access_token=" + access_token + "&verificationurl=" + encodeURIComponent(verificationurl) + "&emailtemplate=" + emailtemplate, function(data) {
                handle(data);
            });
        } else {
            handle(errorMsgs[906]);
    ...
    module.createCustomObjectByToken = function(jsObject, objectname, emailtemplate, handle) {
        var access_token = module.getToken();
        if (access_token) {
            util.xhttpCall("POST", jsObject, "/identity/v2/auth/customobject?access_token=" + access_token + "&objectname=" + objectname, function(data) {
                handle(data);
            });
        } else {
            handle(errorMsgs[906]);
    ...
    module.changePassword = function(jsObject, handle) {
        var access_token = module.getToken();
        if (access_token) {
            util.xhttpCall("PUT", jsObject, "/identity/v2/auth/password?access_token=" + access_token, function(data) {
                handle(data);
            });
        } else {
            handle(errorMsgs[906]);
    ...
    module.linkSocialIdentities = function(jsObject, handle) {
        var access_token = module.getToken();
        if (access_token) {
            util.xhttpCall("PUT", jsObject, "/identity/v2/auth/socialidentity?access_token=" + access_token, function(data) {
                handle(data);
            });
        } else {
            handle(errorMsgs[906]);
    ...
    module.setUserName = function(jsObject, handle) {
        var access_token = module.getToken();
        if (access_token) {
            util.xhttpCall("PUT", jsObject, "/identity/v2/auth/username?access_token=" + access_token, function(data) {
                handle(data);
            });
        } else {
            handle(errorMsgs[906]);
    ...
    module.updateProfileByToken = function(jsObject, verificationurl, emailtemplate, smstemplate, handle) {
        var access_token = module.getToken();
        if (access_token) {
            util.xhttpCall("PUT", jsObject, "/identity/v2/auth/account?access_token=" + access_token + "&verificationurl=" + verificationurl + "&emailtemplate=" + emailtemplate + "&smstemplate=" + smstemplate, function(data) {
                handle(data);
            });
        } else {
            handle(errorMsgs[906]);
    ...
    module.updateSecurityQuestionByToken = function(jsObject, handle) {
        var access_token = module.getToken();
        if (access_token) {
            util.xhttpCall("PUT", jsObject, "/identity/v2/auth/account?access_token=" + access_token, function(data) {
                handle(data);
            });
        } else {
            handle(errorMsgs[906]);
    ...
    module.updateCustomObjectByObjectRecordIdAndToken = function(jsObject, objectname, updatetype, objectrecordid, handle) {
        var access_token = module.getToken();
        if (access_token) {
            util.xhttpCall("PUT", jsObject, "/identity/v2/auth/customobject/" + objectrecordid + "?access_token=" + access_token + "&objectname=" + objectname + "&updatetype=" + updatetype, function(data) {
                handle(data);
            });
        } else {
            handle(errorMsgs[906]);
    ...
    module.deleteAccountWithEmailConfirmation = function(deleteurl, emailtemplate, handle) {
        var access_token = module.getToken();
        if (access_token) {
            util.xhttpCall("DELETE", {}, "/identity/v2/auth/account?access_token=" + access_token + "&deleteurl=" + deleteurl + "&emailtemplate=" + emailtemplate, function(data) {
                handle(data);
            });
        } else {
            handle(errorMsgs[906]);
    ...
    module.removeEmail = function(jsObject, handle) {
        var access_token = module.getToken();
        if (access_token) {
            util.xhttpCall("DELETE", jsObject, "/identity/v2/auth/email?access_token=" + access_token, function(data) {
                handle(data);
            });
        } else {
            handle(errorMsgs[906]);
    ...
    module.unlinkSocialIdentity = function(jsObject, handle) {
        var access_token = module.getToken();
        if (access_token) {
            util.xhttpCall("DELETE", jsObject, "/identity/v2/auth/socialidentity?access_token=" + access_token, function(data) {
                handle(data);
            });
        } else {
            handle(errorMsgs[906]);
    ...
    module.deleteCustomObjectByRecordIdAndToken = function(objectname, objectrecordid, handle) {
        var access_token = module.getToken();
        if (access_token) {
            util.xhttpCall("DELETE", {}, "/identity/v2/auth/customobject/" + objectrecordid + "?access_token=" + access_token + "&objectname=" + objectname, function(data) {
                handle(data);
            });
        } else {
            handle(errorMsgs[906]);
...
`    * @param handle {CallbackHandler} callback handler, invoke after getting Responce from LoginRadius
    ...
    util.xhttpCall = function(method, jsObject, path, handle) {
        var providedapikey = module.getApiKey();
        if (providedapikey) {
        ...
        xhttpcall.open(method, apiDomain + path + (path.indexOf('?') != -1 ? '&' : '?') + "apikey=" + providedapikey);
        ...
        xhttpcall.onerror = function() {
            console.log("Error with XMLHttpRequest")
        };
