...
const emailTemplate = '<emailTemplate>'; // Optional
const fields = null; // Optional
const nullSupport = true; // Optional
const smsTemplate = '<smsTemplate>'; // Optional
const verificationUrl = '<verificationUrl>'; // Optional

LoginRadiusSDK.authenticationApi.updateProfileByAccessToken(
  accessToken,
...
const unlockProfileModel = {
  'g-recaptcha-response': '<g-recaptcha-response>',
}; // Required

LoginRadiusSDK.authenticationApi.unlockAccountByToken(
  accessToken,
  unlockProfileModel,
  function (error, data) {
    if (error) {
...
```js
const emailVerificationByOtpModel = {
  email: '<email>',
  otp: '<otp>',
}; // Required
const fields = null; // Optional
const url = '<url>'; // Optional
const welcomeEmailTemplate = '<welcomeEmailTemplate>'; // Optional

LoginRadiusSDK.authenticationApi.verifyEmailByOTP(
...
```js
const resetPasswordBySecurityAnswerAndEmailModel = {
  email: '<email>',
  password: '<password>',
  securityAnswer: { QuestionID: 'Answer' },
}; // Required

LoginRadiusSDK.authenticationApi.resetPasswordBySecurityAnswerAndEmail(
...
```js
const resetPasswordBySecurityAnswerAndPhoneModel = {
  password: '<password>',
  phone: '<phone>',
  securityAnswer: { QuestionID: 'Answer' },
}; // Required

LoginRadiusSDK.authenticationApi.resetPasswordBySecurityAnswerAndPhone(
...
```js
const resetPasswordBySecurityAnswerAndUserNameModel = {
  password: '<password>',
  securityAnswer: { QuestionID: 'Answer' },
  userName: '<userName>',
}; // Required

LoginRadiusSDK.authenticationApi.resetPasswordBySecurityAnswerAndUserName(
...
```js
const resetPasswordByResetTokenModel = {
  password: '<password>',
  resetToken: '<resetToken>',
}; // Required

LoginRadiusSDK.authenticationApi.resetPasswordByResetToken(
...
```js
const resetPasswordByEmailAndOtpModel = {
  email: '<email>',
  otp: '<otp>',
  password: '<password>',
}; // Required

LoginRadiusSDK.authenticationApi.resetPasswordByEmailOTP(
...
```js
const resetPasswordByUserNameModel = {
  otp: '<otp>',
  password: '<password>',
  userName: '<userName>',
}; // Required

LoginRadiusSDK.authenticationApi.resetPasswordByOTPAndUserName(
...
```js
const accessToken = '<accessToken>'; // Required
const newPassword = '<newPassword>'; // Required
const oldPassword = '<oldPassword>'; // Required

LoginRadiusSDK.authenticationApi.changePassword(
  accessToken,
  newPassword,
  oldPassword,
  function (error, data) {
...
LoginRadiusSDK.authenticationApi.setOrChangeUserName(
  accessToken,
  username,
  function (error, data) {
    if (error) {
...
LoginRadiusSDK.authenticationApi.authResendEmailVerification(
  email,
  emailTemplate,
  verificationUrl,
  function (error, data) {
...
LoginRadiusSDK.authenticationApi.addEmail(
  accessToken,
  email,
  type,
  emailTemplate,
...
const emailTemplate = '<emailTemplate>'; // Optional
const fields = null; // Optional
const loginUrl = '<loginUrl>'; // Optional
const verificationUrl = '<verificationUrl>'; // Optional

LoginRadiusSDK.authenticationApi.loginByEmail(
...
```js
const userNameAuthenticationModel = {
  password: '<password>',
  username: '<username>',
}; // Required
const emailTemplate = '<emailTemplate>'; // Optional
...
LoginRadiusSDK.authenticationApi.loginByUserName(
...
```js
const email = '<email>'; // Required
const resetPasswordUrl = '<resetPasswordUrl>'; // Required
const emailTemplate = '<emailTemplate>'; // Optional

LoginRadiusSDK.authenticationApi.forgotPassword(
  email,
  resetPasswordUrl,
  emailTemplate,
  function (error, data) {
...
```js
const accessToken = '<accessToken>'; // Required
const candidateToken = '<candidateToken>'; // Required

LoginRadiusSDK.authenticationApi.linkSocialIdentities(
  accessToken,
  candidateToken,
  function (error, data) {
    if (error) {
...
```js
const accessToken = '<accessToken>'; // Required
const clientGuid = '<clientGuid>'; // Required

LoginRadiusSDK.authenticationApi.linkSocialIdentitiesByPing(
  accessToken,
  clientGuid,
  function (error, data) {
    if (error) {
...
```js
const authUserRegistrationModel = {
  email: [
    {
      type: '<type>',
      value: '<value>',
...
const sott = '<sott>'; // Required
const emailTemplate = '<emailTemplate>'; // Optional
const fields = null; // Optional
const options = '<options>'; // Optional
const verificationUrl = '<verificationUrl>'; // Optional
const welcomeEmailTemplate = '<welcomeEmailTemplate>'; // Optional

LoginRadiusSDK.authenticationApi.userRegistrationByEmail(
...
```js
const authUserRegistrationModelWithCaptcha = {
  email: [
    {
      type: '<type>',
      value: '<value>',
...
LoginRadiusSDK.authenticationApi.userRegistrationByCaptcha(
...
LoginRadiusSDK.authenticationApi.getSecurityQuestionsByEmail(email, function (
  error,
  data
) {
  if (error) {
...
LoginRadiusSDK.authenticationApi.getSecurityQuestionsByUserName(
  userName,
  function (error, data) {
    if (error) {
      console.log(error);
...
LoginRadiusSDK.authenticationApi.getSecurityQuestionsByPhone(phone, function (
  error,
  data
) {
  if (error) {
...
LoginRadiusSDK.authenticationApi.getSecurityQuestionsByAccessToken(
  accessToken,
  function (error, data) {
    if (error) {
      console.log(error);
...
LoginRadiusSDK.authenticationApi.authValidateAccessToken(accessToken, function (
  error,
  data
) {
  if (error) {
...
```js
const accessToken = '<accessToken>'; // Required
const preventRefresh = true; // Optional

LoginRadiusSDK.authenticationApi.authInValidateAccessToken(
  accessToken,
  preventRefresh,
  function (error, data) {
    if (error) {
...
LoginRadiusSDK.authenticationApi.getAccessTokenInfo(accessToken, function (
  error,
  data
) {
  if (error) {
...
LoginRadiusSDK.authenticationApi.sendWelcomeEmail(
  accessToken,
  welcomeEmailTemplate,
  function (error, data) {
    if (error) {
...
```js
const deletetoken = '<deletetoken>'; // Required

LoginRadiusSDK.authenticationApi.deleteAccountByDeleteToken(
  deletetoken,
  function (error, data) {
    if (error) {
      console.log(error);
...
LoginRadiusSDK.authenticationApi.checkEmailAvailability(email, function (
  error,
  data
) {
  if (error) {
...
```js
const verificationToken = '<verificationToken>'; // Required
const fields = null; // Optional
const url = '<url>'; // Optional
const welcomeEmailTemplate = '<welcomeEmailTemplate>'; // Optional

LoginRadiusSDK.authenticationApi.verifyEmail(
  verificationToken,
  fields,
  url,
  welcomeEmailTemplate,
...
LoginRadiusSDK.authenticationApi.checkUserNameAvailability(username, function (
  error,
  data
) {
  if (error) {
...
LoginRadiusSDK.authenticationApi.acceptPrivacyPolicy(
  accessToken,
  fields,
  function (error, data) {
    if (error) {
...
LoginRadiusSDK.authenticationApi.getPrivacyPolicyHistoryByAccessToken(
  accessToken,
  function (error, data) {
    if (error) {
      console.log(error);
...
```js
const accessToken = '<accessToken>'; // Required
const deleteUrl = '<deleteUrl>'; // Optional
const emailTemplate = '<emailTemplate>'; // Optional

LoginRadiusSDK.authenticationApi.deleteAccountWithEmailConfirmation(
  accessToken,
  deleteUrl,
  emailTemplate,
  function (error, data) {
...
LoginRadiusSDK.authenticationApi.removeEmail(accessToken, email, function (
  error,
  data
) {
  if (error) {
...
```js
const accessToken = '<accessToken>'; // Required
const provider = '<provider>'; // Required
const providerId = '<providerId>'; // Required

LoginRadiusSDK.authenticationApi.unlinkSocialIdentities(
  accessToken,
  provider,
  providerId,
  function (error, data) {
...
const subject = '<subject>'; // Required
const to = '<to>'; // Required

LoginRadiusSDK.socialApi.postMessage(
  accessToken,
  message,
  subject,
  to,
...
```js
const accessToken = '<accessToken>'; // Required
const caption = '<caption>'; // Required
const description = '<description>'; // Required
const imageurl = '<imageurl>'; // Required
const status = '<status>'; // Required
const title = '<title>'; // Required
const url = '<url>'; // Required
const shorturl = '<shorturl>'; // Optional

LoginRadiusSDK.socialApi.statusPosting(
  accessToken,
  caption,
  description,
  imageurl,
...
LoginRadiusSDK.socialApi.trackableStatusPosting(
  accessToken,
  statusModel,
  function (error, data) {
    if (error) {
...
```js
const accessToken = '<accessToken>'; // Required
const nextCursor = '<nextCursor>'; // Required

LoginRadiusSDK.socialApi.getAlbumsWithCursor(accessToken, nextCursor, function (
  error,
  data
) {
  if (error) {
...
LoginRadiusSDK.socialApi.getAudiosWithCursor(accessToken, nextCursor, function (
  error,
  data
) {
  if (error) {
...
LoginRadiusSDK.socialApi.getCheckInsWithCursor(
  accessToken,
  nextCursor,
  function (error, data) {
    if (error) {
...
```js
const accessToken = '<accessToken>'; // Required
const nextCursor = '<nextCursor>'; // Optional

LoginRadiusSDK.socialApi.getContacts(accessToken, nextCursor, function (
  error,
  data
) {
  if (error) {
...
LoginRadiusSDK.socialApi.getEventsWithCursor(accessToken, nextCursor, function (
  error,
  data
) {
  if (error) {
...
LoginRadiusSDK.socialApi.getFollowingsWithCursor(
  accessToken,
  nextCursor,
  function (error, data) {
    if (error) {
...
LoginRadiusSDK.socialApi.getGroupsWithCursor(accessToken, nextCursor, function (
  error,
  data
) {
  if (error) {
...
LoginRadiusSDK.socialApi.getLikesWithCursor(accessToken, nextCursor, function (
  error,
  data
) {
  if (error) {
...
```js
const accessToken = '<accessToken>'; // Required
const pageName = '<pageName>'; // Required
...
```js
const accessToken = '<accessToken>'; // Required
const albumId = '<albumId>'; // Required

LoginRadiusSDK.socialApi.getPhotos(accessToken, albumId, function (
  error,
  data
) {
  if (error) {
...
LoginRadiusSDK.socialApi.getTrackableStatusStats(
  accessToken,
  caption,
  description,
  imageurl,
...
LoginRadiusSDK.socialApi.getSocialUserProfile(accessToken, fields, function (
  error,
  data
) {
  if (error) {
...
LoginRadiusSDK.socialApi.getRefreshedSocialUserProfile(
  accessToken,
  fields,
  function (error, data) {
    if (error) {
...
LoginRadiusSDK.socialApi.getVideos(accessToken, nextCursor, function (
  error,
  data
) {
  if (error) {
...
```js
const accessToken = '<accessToken>'; // Required
const objectName = '<objectName>'; // Required
const objectRecordId = '<objectRecordId>'; // Required

const object = { customdata1: 'Store my customdata1 value' }; // Required
const updateType = '<updateType>'; // Optional

LoginRadiusSDK.customObjectApi.updateCustomObjectByToken(
  accessToken,
  objectName,
  objectRecordId,
  object,
...
LoginRadiusSDK.customObjectApi.createCustomObjectByToken(
  accessToken,
  objectName,
  object,
  function (error, data) {
...
LoginRadiusSDK.customObjectApi.getCustomObjectByToken(
  accessToken,
  objectName,
  function (error, data) {
    if (error) {
...
LoginRadiusSDK.customObjectApi.getCustomObjectByRecordIDAndToken(
  accessToken,
  objectName,
  objectRecordId,
  function (error, data) {
...
LoginRadiusSDK.customObjectApi.deleteCustomObjectByToken(
  accessToken,
  objectName,
  objectRecordId,
  function (error, data) {
...
```js
const resetPasswordByOTPModel = {
  otp: '<otp>',
  password: '<password>',
  phone: '<phone>',
}; // Required

LoginRadiusSDK.phoneAuthenticationApi.resetPasswordByPhoneOTP(
...
```js
const otp = '<otp>'; // Required
const phone = '<phone>'; // Required
const fields = null; // Optional
const smsTemplate = '<smsTemplate>'; // Optional

LoginRadiusSDK.phoneAuthenticationApi.phoneVerificationByOTP(
  otp,
  phone,
  fields,
  smsTemplate,
...
LoginRadiusSDK.phoneAuthenticationApi.phoneVerificationOTPByAccessToken(
  accessToken,
  otp,
  smsTemplate,
  function (error, data) {
...
LoginRadiusSDK.phoneAuthenticationApi.updatePhoneNumber(
  accessToken,
  phone,
  smsTemplate,
  function (error, data) {
...
```js
const phoneAuthenticationModel = {
  password: '<password>',
  phone: '<phone>',
}; // Required
const fields = null; // Optional
...
LoginRadiusSDK.phoneAuthenticationApi.loginByPhone(
...
LoginRadiusSDK.phoneAuthenticationApi.forgotPasswordByPhoneOTP(
  phone,
  smsTemplate,
  function (error, data) {
    if (error) {
...
LoginRadiusSDK.phoneAuthenticationApi.phoneResendVerificationOTP(
  phone,
  smsTemplate,
  function (error, data) {
    if (error) {
...
LoginRadiusSDK.phoneAuthenticationApi.phoneResendVerificationOTPByToken(
  accessToken,
  phone,
  smsTemplate,
  function (error, data) {
...
LoginRadiusSDK.phoneAuthenticationApi.userRegistrationByPhone(
  authUserRegistrationModel,
  sott,
  fields,
  options,
...
LoginRadiusSDK.phoneAuthenticationApi.checkPhoneNumberAvailability(
  phone,
  function (error, data) {
    if (error) {
      console.log(error);
...
LoginRadiusSDK.phoneAuthenticationApi.removePhoneIDByAccessToken(
  accessToken,
  function (error, data) {
    if (error) {
      console.log(error);
...
const multiFactorAuthModelWithLockout = {
  otp: '<otp>',
}; // Required
const fields = null; // Optional

LoginRadiusSDK.multiFactorAuthenticationApi.mfaUpdateSetting(
  accessToken,
...
const multiFactorAuthModelByGoogleAuthenticatorCode = {
  googleAuthenticatorCode: '<googleAuthenticatorCode>',
}; // Required
const fields = null; // Optional
const smsTemplate = '<smsTemplate>'; // Optional

LoginRadiusSDK.multiFactorAuthenticationApi.mfaUpdateByAccessToken(
  accessToken,
...
```js
const accessToken = '<accessToken>'; // Required
const phoneNo2FA = '<phoneNo2FA>'; // Required
const smsTemplate2FA = '<smsTemplate2FA>'; // Optional

LoginRadiusSDK.multiFactorAuthenticationApi.mfaUpdatePhoneNumberByToken(
  accessToken,
  phoneNo2FA,
  smsTemplate2FA,
  function (error, data) {
...
const secondFactorAuthenticationToken = '<secondFactorAuthenticationToken>'; // Required
const fields = null; // Optional
const smsTemplate2FA = '<smsTemplate2FA>'; // Optional

LoginRadiusSDK.multiFactorAuthenticationApi.mfaValidateOTPByPhone(
  multiFactorAuthModelWithLockout,
...
```js
const googleAuthenticatorCode = '<googleAuthenticatorCode>'; // Required
const secondFactorAuthenticationToken = '<secondFactorAuthenticationToken>'; // Required
const fields = null; // Optional
const smsTemplate2FA = '<smsTemplate2FA>'; // Optional

LoginRadiusSDK.multiFactorAuthenticationApi.mfaValidateGoogleAuthCode(
...
```js
const multiFactorAuthModelByBackupCode = {
  backupCode: '<backupCode>',
}; // Required
const secondFactorAuthenticationToken = '<secondFactorAuthenticationToken>'; // Required
const fields = null; // Optional

LoginRadiusSDK.multiFactorAuthenticationApi.mfaValidateBackupCode(
...
LoginRadiusSDK.multiFactorAuthenticationApi.mfaUpdatePhoneNumber(
  phoneNo2FA,
  secondFactorAuthenticationToken,
  smsTemplate2FA,
  function (error, data) {
...
LoginRadiusSDK.multiFactorAuthenticationApi.mfaLoginByEmail(
  email,
  password,
  emailTemplate,
  fields,
...
LoginRadiusSDK.multiFactorAuthenticationApi.mfaLoginByUserName(
  password,
  username,
  emailTemplate,
  fields,
...
LoginRadiusSDK.multiFactorAuthenticationApi.mfaLoginByPhone(
  password,
  phone,
  emailTemplate,
  fields,
...
LoginRadiusSDK.multiFactorAuthenticationApi.mfaConfigureByAccessToken(
  accessToken,
  smsTemplate2FA,
  function (error, data) {
    if (error) {
...
LoginRadiusSDK.multiFactorAuthenticationApi.mfaBackupCodeByAccessToken(
  accessToken,
  function (error, data) {
    if (error) {
      console.log(error);
...
LoginRadiusSDK.multiFactorAuthenticationApi.mfaResetBackupCodeByAccessToken(
  accessToken,
  function (error, data) {
    if (error) {
      console.log(error);
...
LoginRadiusSDK.multiFactorAuthenticationApi.mfaResendOTP(
  secondFactorAuthenticationToken,
  smsTemplate2FA,
  function (error, data) {
    if (error) {
...
```js
const accessToken = '<accessToken>'; // Required
const googleauthenticator = true; // Required

LoginRadiusSDK.multiFactorAuthenticationApi.mfaResetGoogleAuthByToken(
  accessToken,
  googleauthenticator,
  function (error, data) {
    if (error) {
...
```js
const accessToken = '<accessToken>'; // Required
const otpauthenticator = true; // Required

LoginRadiusSDK.multiFactorAuthenticationApi.mfaResetSMSAuthByToken(
  accessToken,
  otpauthenticator,
  function (error, data) {
    if (error) {
...
```js
const resetPINByResetToken = {
  pin: '<pin>',
  resetToken: '<resetToken>',
}; // Required

LoginRadiusSDK.pinAuthenticationApi.resetPINByResetToken(
...
```js
const resetPINBySecurityQuestionAnswerAndEmailModel = {
  email: '<email>',
  pin: '<pin>',
  securityAnswer: { QuestionID: 'Answer' },
}; // Required

LoginRadiusSDK.pinAuthenticationApi.resetPINByEmailAndSecurityAnswer(
...
```js
const resetPINBySecurityQuestionAnswerAndUsernameModel = {
  pin: '<pin>',
  securityAnswer: { QuestionID: 'Answer' },
  username: '<username>',
}; // Required

LoginRadiusSDK.pinAuthenticationApi.resetPINByUsernameAndSecurityAnswer(
...
```js
const resetPINBySecurityQuestionAnswerAndPhoneModel = {
  phone: '<phone>',
  pin: '<pin>',
  securityAnswer: { QuestionID: 'Answer' },
}; // Required

LoginRadiusSDK.pinAuthenticationApi.resetPINByPhoneAndSecurityAnswer(
...
LoginRadiusSDK.pinAuthenticationApi.changePINByAccessToken(
  accessToken,
  changePINModel,
  function (error, data) {
    if (error) {
...
```js
const resetPINByPhoneAndOTPModel = {
  otp: '<otp>',
  phone: '<phone>',
  pin: '<pin>',
}; // Required

LoginRadiusSDK.pinAuthenticationApi.resetPINByPhoneAndOtp(
...
```js
const resetPINByEmailAndOtpModel = {
  email: '<email>',
  otp: '<otp>',
  pin: '<pin>',
}; // Required

LoginRadiusSDK.pinAuthenticationApi.resetPINByEmailAndOtp(
...
```js
const resetPINByUsernameAndOtpModel = {
  otp: '<otp>',
  pin: '<pin>',
  username: '<username>',
}; // Required

LoginRadiusSDK.pinAuthenticationApi.resetPINByUsernameAndOtp(
...
```js
const loginByPINModel = {
  pin: '<pin>',
}; // Required
const sessionToken = '<sessionToken>'; // Required

LoginRadiusSDK.pinAuthenticationApi.pinLogin(
  loginByPINModel,
  sessionToken,
  function (error, data) {
    if (error) {
...
```js
const forgotPINLinkByEmailModel = {
  email: '<email>',
}; // Required
const emailTemplate = '<emailTemplate>'; // Optional
const resetPINUrl = '<resetPINUrl>'; // Optional

LoginRadiusSDK.pinAuthenticationApi.sendForgotPINEmailByEmail(
...
```js
const forgotPINLinkByUserNameModel = {
  userName: '<userName>',
}; // Required
const emailTemplate = '<emailTemplate>'; // Optional
const resetPINUrl = '<resetPINUrl>'; // Optional

LoginRadiusSDK.pinAuthenticationApi.sendForgotPINEmailByUsername(
...
```js
const forgotPINOtpByPhoneModel = {
  phone: '<phone>',
}; // Required
const smsTemplate = '<smsTemplate>'; // Optional

LoginRadiusSDK.pinAuthenticationApi.sendForgotPINSMSByPhone(
...
```js
const pinRequiredModel = {
  pin: '<pin>',
}; // Required
const pinAuthToken = '<pinAuthToken>'; // Required

LoginRadiusSDK.pinAuthenticationApi.setPINByPinAuthToken(
  pinRequiredModel,
  pinAuthToken,
  function (error, data) {
    if (error) {
...
LoginRadiusSDK.pinAuthenticationApi.inValidatePinSessionToken(
  sessionToken,
  function (error, data) {
    if (error) {
      console.log(error);
...
const reauthByOtpModel = {
  otp: '<otp>',
}; // Required

LoginRadiusSDK.reAuthenticationApi.mfaReAuthenticateByOTP(
  accessToken,
  reauthByOtpModel,
  function (error, data) {
    if (error) {
...
const reauthByBackupCodeModel = {
  backupCode: '<backupCode>',
}; // Required

LoginRadiusSDK.reAuthenticationApi.mfaReAuthenticateByBackupCode(
  accessToken,
...
const reauthByGoogleAuthenticatorCodeModel = {
  googleAuthenticatorCode: '<googleAuthenticatorCode>',
}; // Required

LoginRadiusSDK.reAuthenticationApi.mfaReAuthenticateByGoogleAuth(
  accessToken,
...
const passwordEventBasedAuthModelWithLockout = {
  password: '<password>',
}; // Required
const smsTemplate2FA = '<smsTemplate2FA>'; // Optional

LoginRadiusSDK.reAuthenticationApi.mfaReAuthenticateByPassword(
  accessToken,
...
const pinAuthEventBasedAuthModelWithLockout = {
  pin: '<pin>',
}; // Required
const smsTemplate2FA = '<smsTemplate2FA>'; // Optional

LoginRadiusSDK.reAuthenticationApi.verifyPINAuthentication(
  accessToken,
...
LoginRadiusSDK.reAuthenticationApi.mfaReAuthenticate(
  accessToken,
  smsTemplate2FA,
  function (error, data) {
    if (error) {
...
LoginRadiusSDK.consentManagementApi.updateConsentProfileByAccessToken(
  accessToken,
  consentUpdateModel,
  function (error, data) {
    if (error) {
...
```js
const consentToken = '<consentToken>'; // Required

const consentSubmitModel = {
  data: [
    {
      consentOptionId: '<consentOptionId>',
      isAccepted: true,
...
LoginRadiusSDK.consentManagementApi.submitConsentByConsentToken(
  consentToken,
  consentSubmitModel,
  function (error, data) {
    if (error) {
...
LoginRadiusSDK.consentManagementApi.submitConsentByAccessToken(
  accessToken,
  consentSubmitModel,
  function (error, data) {
    if (error) {
...
LoginRadiusSDK.consentManagementApi.getConsentLogs(accessToken, function (
  error,
  data
) {
  if (error) {
...
```js
const accessToken = '<accessToken>'; // Required
const event = '<event>'; // Required
const isCustom = true; // Required

LoginRadiusSDK.consentManagementApi.verifyConsentByAccessToken(
  accessToken,
  event,
  isCustom,
  function (error, data) {
...
LoginRadiusSDK.smartLoginApi.smartLoginTokenVerification(
  verificationToken,
  welcomeEmailTemplate,
  function (error, data) {
    if (error) {
...
const clientGuid = '<clientGuid>'; // Required
const email = '<email>'; // Required
const redirectUrl = '<redirectUrl>'; // Optional
const smartLoginEmailTemplate = '<smartLoginEmailTemplate>'; // Optional
const welcomeEmailTemplate = '<welcomeEmailTemplate>'; // Optional

LoginRadiusSDK.smartLoginApi.smartLoginByEmail(
  clientGuid,
  email,
  redirectUrl,
...
LoginRadiusSDK.smartLoginApi.smartLoginByUserName(
  clientGuid,
  username,
  redirectUrl,
  smartLoginEmailTemplate,
...
LoginRadiusSDK.smartLoginApi.smartLoginPing(clientGuid, fields, function (
  error,
  data
) {
  if (error) {
...
LoginRadiusSDK.oneTouchLoginApi.oneTouchLoginOTPVerification(
  otp,
  phone,
  fields,
  smsTemplate,
...
```js
const oneTouchLoginByEmailModel = {
  clientguid: '<clientguid>',
  email: '<email>',
  'g-recaptcha-response': '<g-recaptcha-response>',
}; // Required
const oneTouchLoginEmailTemplate = '<oneTouchLoginEmailTemplate>'; // Optional
const redirecturl = '<redirecturl>'; // Optional
const welcomeemailtemplate = '<welcomeemailtemplate>'; // Optional

LoginRadiusSDK.oneTouchLoginApi.oneTouchLoginByEmail(
...
```js
const oneTouchLoginByPhoneModel = {
  'g-recaptcha-response': '<g-recaptcha-response>',
  phone: '<phone>',
}; // Required
const smsTemplate = '<smsTemplate>'; // Optional

LoginRadiusSDK.oneTouchLoginApi.oneTouchLoginByPhone(
...
LoginRadiusSDK.oneTouchLoginApi.oneTouchEmailVerification(
  verificationToken,
  welcomeEmailTemplate,
  function (error, data) {
    if (error) {
...
LoginRadiusSDK.oneTouchLoginApi.oneTouchLoginPing(clientGuid, fields, function (
  error,
  data
) {
  if (error) {
...
```js
const passwordLessLoginOtpModel = {
  otp: '<otp>',
  phone: '<phone>',
}; // Required
const fields = null; // Optional
...
LoginRadiusSDK.passwordLessLoginApi.passwordlessLoginPhoneVerification(
...
LoginRadiusSDK.passwordLessLoginApi.passwordlessLoginByPhone(
  phone,
  smsTemplate,
  function (error, data) {
    if (error) {
...
```js
const email = '<email>'; // Required
const passwordLessLoginTemplate = '<passwordLessLoginTemplate>'; // Optional
const verificationUrl = '<verificationUrl>'; // Optional

LoginRadiusSDK.passwordLessLoginApi.passwordlessLoginByEmail(
  email,
...
LoginRadiusSDK.passwordLessLoginApi.passwordlessLoginByUserName(
  username,
  passwordLessLoginTemplate,
  verificationUrl,
  function (error, data) {
...
LoginRadiusSDK.passwordLessLoginApi.passwordlessLoginVerification(
  verificationToken,
  fields,
  welcomeEmailTemplate,
  function (error, data) {
...
```js
const timeDifference = 0; // Optional

LoginRadiusSDK.configurationApi.getServerInfo(timeDifference, function (
  error,
  data
) {
  if (error) {
...
const recordId = '<recordId>'; // Required

LoginRadiusSDK.customRegistrationDataApi.validateRegistrationDataCode(
  code,
  recordId,
  function (error, data) {
    if (error) {
...
```js
const type = '<type>'; // Required
const limit = 0; // Optional
const parentId = '<parentId>'; // Optional
const skip = 0; // Optional

LoginRadiusSDK.customRegistrationDataApi.authGetRegistrationData(
  type,
  limit,
  parentId,
  skip,
...
const fields = null; // Optional
const loginUrl = '<loginUrl>'; // Optional
const passwordDelegation = true; // Optional
const passwordDelegationApp = '<passwordDelegationApp>'; // Optional
const rbaBrowserEmailTemplate = '<rbaBrowserEmailTemplate>'; // Optional
const rbaBrowserSmsTemplate = '<rbaBrowserSmsTemplate>'; // Optional
const rbaCityEmailTemplate = '<rbaCityEmailTemplate>'; // Optional
const rbaCitySmsTemplate = '<rbaCitySmsTemplate>'; // Optional
const rbaCountryEmailTemplate = '<rbaCountryEmailTemplate>'; // Optional
const rbaCountrySmsTemplate = '<rbaCountrySmsTemplate>'; // Optional
const rbaIpEmailTemplate = '<rbaIpEmailTemplate>'; // Optional
const rbaIpSmsTemplate = '<rbaIpSmsTemplate>'; // Optional
const rbaOneclickEmailTemplate = '<rbaOneclickEmailTemplate>'; // Optional
const rbaOTPSmsTemplate = '<rbaOTPSmsTemplate>'; // Optional
const smsTemplate = '<smsTemplate>'; // Optional
const verificationUrl = '<verificationUrl>'; // Optional

LoginRadiusSDK.riskBasedAuthenticationApi.rbaLoginByEmail(
  emailAuthenticationModel,
  emailTemplate,
  fields,
  loginUrl,
...
LoginRadiusSDK.riskBasedAuthenticationApi.rbaLoginByUserName(
  userNameAuthenticationModel,
  emailTemplate,
  fields,
  loginUrl,
...
LoginRadiusSDK.riskBasedAuthenticationApi.rbaLoginByPhone(
  phoneAuthenticationModel,
  emailTemplate,
  fields,
  loginUrl,
...
```js
const fbAccessToken = '<fbAccessToken>'; // Required
const socialAppName = '<socialAppName>'; // Optional

LoginRadiusSDK.nativeSocialApi.getAccessTokenByFacebookAccessToken(
  fbAccessToken,
  socialAppName,
  function (error, data) {
    if (error) {
...
```js
const twAccessToken = '<twAccessToken>'; // Required
const twTokenSecret = '<twTokenSecret>'; // Required
const socialAppName = '<socialAppName>'; // Optional

LoginRadiusSDK.nativeSocialApi.getAccessTokenByTwitterAccessToken(
  twAccessToken,
  twTokenSecret,
  socialAppName,
  function (error, data) {
...
```js
const googleAccessToken = '<googleAccessToken>'; // Required
const clientId = '<clientId>'; // Optional
const refreshToken = '<refreshToken>'; // Optional
const socialAppName = '<socialAppName>'; // Optional

LoginRadiusSDK.nativeSocialApi.getAccessTokenByGoogleAccessToken(
  googleAccessToken,
  clientId,
  refreshToken,
  socialAppName,
...
```js
const idToken = '<idToken>'; // Required

LoginRadiusSDK.nativeSocialApi.getAccessTokenByGoogleJWTAccessToken(
  idToken,
  function (error, data) {
    if (error) {
      console.log(error);
...
```js
const lnAccessToken = '<lnAccessToken>'; // Required
const socialAppName = '<socialAppName>'; // Optional

LoginRadiusSDK.nativeSocialApi.getAccessTokenByLinkedinAccessToken(
  lnAccessToken,
  socialAppName,
  function (error, data) {
    if (error) {
...
```js
const fsAccessToken = '<fsAccessToken>'; // Required

LoginRadiusSDK.nativeSocialApi.getAccessTokenByFoursquareAccessToken(
  fsAccessToken,
  function (error, data) {
    if (error) {
      console.log(error);
...
LoginRadiusSDK.nativeSocialApi.getAccessTokenByAppleIdCode(
  code,
  socialAppName,
  function (error, data) {
    if (error) {
...
LoginRadiusSDK.nativeSocialApi.getAccessTokenByWeChatCode(code, function (
  error,
  data
) {
  if (error) {
...
```js
const vkAccessToken = '<vkAccessToken>'; // Required

LoginRadiusSDK.nativeSocialApi.getAccessTokenByVkontakteAccessToken(
  vkAccessToken,
  function (error, data) {
    if (error) {
      console.log(error);
...
```js
const googleAuthcode = '<googleAuthcode>'; // Required
const socialAppName = '<socialAppName>'; // Optional

LoginRadiusSDK.nativeSocialApi.getAccessTokenByGoogleAuthCode(
  googleAuthcode,
  socialAppName,
  function (error, data) {
    if (error) {
